...
public class ProcessManagerWindow extends BaseAlgorithmWindow {
    ...
    public ProcessManagerWindow(StackPane parentContainer) {
        super("Central PCB Repository - Global Process Control", parentContainer);
        ...
        // Populate the inherited workspace (provided by BaseAlgorithmWindow) instead of building our own shell
        workspace.getChildren().addAll(inputGrid, actionRow, table);
    }
